...
<footer className=" mt-32bg-white">
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700">ahmed@gmail.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700">01068366419</span>
              </a>
            </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Ahmed Khaled</p>
      </div>
    </div>
  </div>
</footer>
